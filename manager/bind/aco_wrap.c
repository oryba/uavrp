...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__aco

#else
#  define SWIG_init    init_aco

#endif
#define SWIG_name    "_aco"
...
extern double greedy(double * distances, int dim, int n);
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_greedy(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:greedy",&obj0,&obj1)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "greedy" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  result = (double)greedy(arg1,arg2,arg3);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"greedy", _wrap_greedy, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
