#!/usr/bin/env bash
cd manager/bind
swig -python -c++ -o aco_wrap.c ../../aco.i
g++ -c -std=c++11 -arch x86_64 -fPIC ../../*.cpp \
    -I ..
g++ -c -std=c++11 -arch x86_64 -fPIC aco_wrap.c -o aco_wrap.o \
...
ld -bundle -macosx_version_min 10.13 -flat_namespace -undefined suppress -o _aco.so *.o
